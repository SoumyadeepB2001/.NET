<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="PhoneBook.Login.login" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="clearfix">
            ...
            <br />
            <br />
            <p class="text-center"><a href="/Login/register.aspx">Create an account</a></p>
        </div>
        </form>
